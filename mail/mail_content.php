                      ...
                      <div style="
                        ...
                        <div class="txtTinyMce-wrapper" style="
                          ...
                          <p style="
                              ...
                              ">
                            Order number:
                            <span style="color: #fb3c2d"><strong><?php echo count($_SESSION['cart']) ?></strong></span>
                          </p>
                        </div>
                      </div>
                      <!--[if mso]></td></tr></table><![endif]-->
                        ...
                        <div style="
                          ...
                          <div class="txtTinyMce-wrapper" style="
                            ...
                            <p style="
                                ...
                                margin: 0;
                              ">
                              <?php echo $item['price'] * $item['number'];
                              ?> VNĐ
                            </p>
                          </div>
                        </div>
                      ...
                      <div style="
                        ...
                        <div class="txtTinyMce-wrapper" style="
                          ...
                          <p style="
                                ...
                                margin: 0;
                              ">
                            <span style="font-size: 16px"><strong>Tổng phụ</strong></span>
                          </p>
                        </div>
                      </div>
                      <!--[if mso]></td></tr></table><![endif]-->
                      ...
                      <div style="
                        ...
                        <div class="txtTinyMce-wrapper" style="
                          ...
                          <p style="
                                ...
                                margin: 0;
                              ">
                            <span style="font-size: 16px"><?php echo $sum ?></span>
                          </p>
                        </div>
                      </div>
                      <!--[if mso]></td></tr></table><![endif]-->
                      ...
                      <div style="
                        ...
                        <div class="txtTinyMce-wrapper" style="
                          ...
                          <p style="
                                ...
                                margin: 0;
                              ">
                            <span style="font-size: 16px"><strong>Phí vận chuyển</strong></span>
                          </p>
                        </div>
                      </div>
                      <!--[if mso]></td></tr></table><![endif]-->
                      ...
                      <div style="
                        ...
                        <div class="txtTinyMce-wrapper" style="
                          ...
                          <p style="
                                ...
                                margin: 0;
                              ">
                            <span style="font-size: 16px">40,000 VNĐ</span>
                          </p>
                        </div>
                      </div>
                      <!--[if mso]></td></tr></table><![endif]-->
                      ...
                      <div style="
                        ...
                        <div class="txtTinyMce-wrapper" style="
                          ...
                          <p style="
                                ...
                                margin: 0;
                              ">
                            <span style="font-size: 22px"><strong><span style="">Tổng cộng <?php echo $sum ?> VNĐ </span></strong></span>
                          </p>
                        </div>
                      </div>
                      <!--[if mso]></td></tr></table><![endif]-->
