                ...
                <ul class="list-group mb-3">
                  <li class="list-group-item d-flex justify-content-between lh-sm">
                    ...
                    <div class="flex-grow-1 ms-3">
                      <h6 class="my-0">Ghế Luxury</h6>
                      <small class="text-muted">Đen / Nhỏ</small>
                    </div>
                    <span class="text-muted">570.000 VNĐ</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between lh-sm">
                    <div class="flex-shrink-0">
                      <img src="https://bizweb.dktcdn.net/thumb/thumb/100/364/402/products/t-g-2-master.jpg?v=1566942776260" alt="" class="product-img">
                    </div>
                    <div class="flex-grow-1 ms-3">
                      <h6 class="my-0">Bàn Aillen 02</h6>
                      <small class="text-muted"></small>
                    </div>
                    <span class="text-muted">670.000 VNĐ</span>
                  </li>
                </ul>
